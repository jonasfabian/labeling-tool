...
)
{
  ...
  def this(alias : String) = {
    this(DSL.name(alias), null, null, ch.labeling_tool.db.tables.Avatar.AVATAR, null)
  }

  def this(alias : Name) = {
    this(alias, null, null, ch.labeling_tool.db.tables.Avatar.AVATAR, null)
  }
  ...
  def this(child : Table[_ <: Record], key : ForeignKey[_ <: Record, AvatarRecord]) = {
    this(Internal.createPathAlias(child, key), child, key, ch.labeling_tool.db.tables.Avatar.AVATAR, null)
  }

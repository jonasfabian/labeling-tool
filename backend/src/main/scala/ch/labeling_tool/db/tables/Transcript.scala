...
)
{
  ...
  def this(alias : String) = {
    this(DSL.name(alias), null, null, ch.labeling_tool.db.tables.Transcript.TRANSCRIPT, null)
  }

  def this(alias : Name) = {
    this(alias, null, null, ch.labeling_tool.db.tables.Transcript.TRANSCRIPT, null)
  }
  ...
  def this(child : Table[_ <: Record], key : ForeignKey[_ <: Record, TranscriptRecord]) = {
    this(Internal.createPathAlias(child, key), child, key, ch.labeling_tool.db.tables.Transcript.TRANSCRIPT, null)
  }

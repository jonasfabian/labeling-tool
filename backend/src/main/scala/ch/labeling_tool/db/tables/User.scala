...
)
{
  ...
  def this(alias : String) = {
    this(DSL.name(alias), null, null, ch.labeling_tool.db.tables.User.USER, null)
  }

  def this(alias : Name) = {
    this(alias, null, null, ch.labeling_tool.db.tables.User.USER, null)
  }
  ...
  def this(child : Table[_ <: Record], key : ForeignKey[_ <: Record, UserRecord]) = {
    this(Internal.createPathAlias(child, key), child, key, ch.labeling_tool.db.tables.User.USER, null)
  }
